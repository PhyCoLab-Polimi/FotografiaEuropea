...
//		parent.background(0); // colore del background
		parent.colorMode(PApplet.RGB, 255, 255, 255, 100); // modalità colore: RGB o HSV e relativiu valori massimi per ciascun canale
...
//		    float y = parent.pow(theRec.acc.y, 2); //accedete ai dati di accelerazione all'interno della classe Rcvr con la formula theRec.acc.x o .y o .z
		    float x = theRec.acc.x*accAmpl; //accedete ai dati di accelerazione all'interno della classe Rcvr con la formula theRec.acc.x o .y o .z
